<template>
  <div class="toolbar">
    <button @click="$emit('undo')" class="btn-icon" title="Desfazer">
      <Undo2 :size="16" />
    </button>
    <button @click="$emit('redo')" class="btn-icon" title="Refazer">
      <Redo2 :size="16" />
    </button>
    ...
    <div class="flex gap-1.5 sm:gap-2 shrink-0">
      <button @click="$emit('download-md')" class="btn-secondary flex items-center gap-1.5" title="Baixar como .md">
        <Download :size="14" />
        <span class="hidden xs:inline">.MD</span>
      </button>
      <button @click="$emit('download-pdf')" class="btn-primary flex items-center gap-1.5" title="Baixar como .pdf">
        <Download :size="14" />
